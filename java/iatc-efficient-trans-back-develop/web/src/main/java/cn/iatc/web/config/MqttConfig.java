...
import cn.iatc.web.helper.mqtt.MqttClientHelper;
...
//    @Bean(name = "mqttManager")
    public MqttManager mqttManager() {
        ...
        try {
            mqttManager  = new MqttManager(hostUrl, snowFlakeFactory.nextIdStr());
            mqttManager.setMqttCallback(new MqttClientHelper("mqttManager"));
            String caPath = null;
