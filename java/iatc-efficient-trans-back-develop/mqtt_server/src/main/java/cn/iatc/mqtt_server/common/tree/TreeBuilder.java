package cn.iatc.mqtt_server.common.tree;

import cn.iatc.mqtt_server.common.tree.data.BaseNode;
...
public class TreeBuilder<T, K> {
    ...
    public TreeBuilder(List<BaseNode<T, K>> nodes) {
        this.nodes = nodes;
    }

    public String buildTreeJson(List<BaseNode<T, K>> nodes) {
        TreeBuilder<T, K> treeBuilder = new TreeBuilder<>(nodes);
